...
import { rekomendasiJakartaData } from "@/data/mockKoses";

export default function RekomendasiJakartaSection() {
  ...
  return (
    <section className="w-full bg-white py-6 lg:py-8 select-none">
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
        {/* ========================================================================= */}
        {/* DESKTOP HEADER LAYOUT (Gambar 2 Laptop) */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* MOBILE HEADER LAYOUT (Gambar 2 Mobile) */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* MOBILE 2x2 GRID VIEW (Gambar 2 Mobile) */}
        {/* ========================================================================= */}
        <div className="md:hidden space-y-4">
          <div className="grid grid-cols-2 gap-3">
            {rekomendasiJakartaData.slice(0, 4).map((item) => (
