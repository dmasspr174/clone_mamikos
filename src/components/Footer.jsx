      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <a href="#" className="flex items-center">
              ...
              />
              <span className="ml-2 font-bold text-xl text-[#00BA88]">
                mamikos
              </span>
            </a>
        ...
        <div className="pt-8 border-t border-slate-200/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full border-2 border-amber-500/80 flex flex-col items-center justify-center p-0.5 text-[8px] font-bold text-slate-700 leading-tight text-center bg-amber-50/30">
              <span className="text-amber-600 text-[7px] font-extrabold">
                SGS
              </span>
              <span className="text-[6px] text-slate-500">ISO 27001</span>
            </div>
          </div>
