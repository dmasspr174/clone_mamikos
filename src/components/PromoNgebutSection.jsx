...
import { promoNgebutData } from "@/data/mockKoses";

export default function PromoNgebutSection() {
      ...
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 space-y-5">
        ...
        <div className="hidden md:flex items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            {/* Countdown Timer Box */}
            <div className="flex items-center gap-2 text-sm text-slate-500 font-medium ml-4">
              <span>Akan Berakhir dalam waktu:</span>
              <div className="flex items-center gap-1 font-bold text-slate-800">
                <span className="px-2 py-1 bg-slate-100 rounded-md border border-slate-200">
                  25 Hari
                </span>
                <span className="px-1.5 py-1 bg-slate-100 rounded-md border border-slate-200">
                  10
                </span>
                <span>:</span>
                <span className="px-1.5 py-1 bg-slate-100 rounded-md border border-slate-200">
        ...
        {/* ========================================================================= */}
        {/* MOBILE HEADER LAYOUT (Gambar 1 Mobile) */}
        {/* ========================================================================= */}
        <div className="md:hidden space-y-3">
          ...
          {/* Row 2: Full-width Dropdown Select Box */}
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
          ...
          {/* Row 3: Countdown Timer right-aligned */}
          <div className="flex items-center justify-end gap-1.5 text-xs text-slate-500 font-medium pt-1">
            <span className="text-[11px]">Akan Berakhir dalam waktu:</span>
            <div className="flex items-center gap-1 font-bold text-slate-800 text-xs">
              <span className="px-1.5 py-0.5 bg-slate-100 rounded border border-slate-200">
                25 Hari
              </span>
              <span className="px-1 py-0.5 bg-slate-100 rounded border border-slate-200">
                10
              </span>
              <span>:</span>
              <span className="px-1 py-0.5 bg-slate-100 rounded border border-slate-200">
        ...
        {/* ========================================================================= */}
        {/* MOBILE 2x2 GRID VIEW (Gambar 1 Mobile) */}
        {/* ========================================================================= */}
        <div className="md:hidden space-y-4">
          <div className="grid grid-cols-2 gap-3">
            {promoNgebutData.slice(0, 4).map((item) => (
